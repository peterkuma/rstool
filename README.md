...
rstool converts native radiosonde data to NetCDF raw, points (pts) and profile
(prof) datasets and calculates derived profile variables.
...
- `imet` - InterMet Systems iMet-1-ABxn. `input` should be the directory
