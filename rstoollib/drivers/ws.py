...
PARAMS = [
	...
	(b'ang', 'wind direction', 'degree', 'float'),
	(b'ang\d', 'wind direction (old)', 'degree', 'float'),
	...
	(b'datetime', 'seconds since file-start', 'second', 'int'),
