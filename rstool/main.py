...
Input types:
  ...
  pts            rstool points ("pts") format (NetCDF). Collection of measurement points, not interpolated to any vertical coordinates. The output of running rstool with the output type "pts".
